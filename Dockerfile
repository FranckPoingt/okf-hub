...
EXPOSE 8788
CMD ["deno", "run", "--cached-only", "--allow-net", "--allow-run=git", "--allow-env=OKF_HOST,OKF_PORT,PORT,PORTLESS_URL,OKF_DATA_DIR,OKF_STATIC_DIR,OKF_BASE_URL,OKF_AUTH_SECRET,OKF_OPENFGA_URL,OKF_OPENFGA_KEY,OKF_S3_ENDPOINT,OKF_S3_ACCESS_KEY,OKF_S3_SECRET_KEY,OKF_S3_BUCKET,OKF_AUTOMATION_INTERVAL_MS,OKF_ARTIFACT_ALLOWED_HOSTS,OKF_GITHUB_APP_ID,OKF_GITHUB_APP_SLUG,OKF_GITHUB_PRIVATE_KEY,OKF_GITHUB_WEBHOOK_SECRET,OKF_SSO_CONFIG_FILE,OKF_AI_PROVIDER,OKF_AI_MODEL,OKF_AI_URL,OKF_AI_API_KEY,OLLAMA_API_KEY,PRODUCTION,NODE_ENV,NODE_DISABLE_COLORS,BETTER_AUTH_TELEMETRY,BETTER_AUTH_TELEMETRY_DEBUG,BETTER_AUTH_TELEMETRY_ENDPOINT,BETTER_AUTH_TRUSTED_ORIGINS,TEST", "--allow-read=/data,/app/dist,/config,/run/secrets", "--allow-write=/data", "server/main.ts"]

...
const SIDEBAR_WIDTH_STORAGE_KEY = "okf_sidebar_width";
...
function SidebarRail({
  ...
  const { sidebarWidth, setSidebarWidth, state, toggleSidebar } = useSidebar();
  ...
  return (
    <button
      ...
      onPointerDown={(event) => {
        ...
        const side = event.currentTarget.closest("[data-side]")
